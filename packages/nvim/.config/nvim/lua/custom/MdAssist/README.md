...
```sh
rm -rf doc
mv plugin/mdassist.lua plugin/my-awesome-plugin.lua
mv lua/mdassist lua/my-awesome-plugin
...
```vim
:vimgrep /MdAssist/ **/*
:cfdo %s/MdAssist/MyAwesomePlugin/g | update

:vimgrep /mdassist/ **/* .github/**
:cfdo %s/mdassist/my-awesome-plugin/g | update
