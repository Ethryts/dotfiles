...
---Saves the state in the global _G.MdAssist.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.MdAssist.state")

    _G.MdAssist.state = self
end
...
---Whether the MdAssist is enabled or not.
---
