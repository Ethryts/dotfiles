...
> **Note**: The options are also available in Neovim by calling `:h mdassist.options`

```lua
require("mdassist").setup({
    -- you can copy the full list from lua/mdassist/config.lua
})
```
